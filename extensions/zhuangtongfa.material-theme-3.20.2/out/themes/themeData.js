...
exports.default = {
    editorThemes: {
        Ayu: () => Promise.resolve().then(() => __importStar(require('./data/ayu'))),
        'Dark Modern': () => Promise.resolve().then(() => __importStar(require('./data/darkModern'))),
        Gnome: () => Promise.resolve().then(() => __importStar(require('./data/gnome'))),
        'Just Black': () => Promise.resolve().then(() => __importStar(require('./data/justBlack'))),
        Nord: () => Promise.resolve().then(() => __importStar(require('./data/nord'))),
        Ocean: () => Promise.resolve().then(() => __importStar(require('./data/ocean'))),
        'One Dark Pro': () => Promise.resolve().then(() => __importStar(require('./data/oneDarkPro'))),
        'One Dark Pro Darker': () => Promise.resolve().then(() => __importStar(require('./data/oneDarkProDarker'))),
        'One Dark Pro Flat': () => Promise.resolve().then(() => __importStar(require('./data/oneDarkProFlat'))),
        'One Dark Pro Mix': () => Promise.resolve().then(() => __importStar(require('./data/oneDarkProMix'))),
        'One Dark Pro Night Flat': () => Promise.resolve().then(() => __importStar(require('./data/oneDarkProNightFlat'))),
        Panda: () => Promise.resolve().then(() => __importStar(require('./data/panda'))),
        Retro: () => Promise.resolve().then(() => __importStar(require('./data/retro'))),
        Shadow: () => Promise.resolve().then(() => __importStar(require('./data/shadow'))),
        Solarized: () => Promise.resolve().then(() => __importStar(require('./data/solarized'))),
        'Solarized Flat': () => Promise.resolve().then(() => __importStar(require('./data/solarizedFlat'))),
        Tokyo: () => Promise.resolve().then(() => __importStar(require('./data/tokyo'))),
        'VS Code': () => Promise.resolve().then(() => __importStar(require('./data/vscode'))),
    },
    textColors: {
        classic: {
            chalky: '#e5c07b',
