...
exports.withModernUiTokens = withModernUiTokens;
function createModernUiTokens(colors) {
    return {
        // Chat
        ...
        'chat.slashCommandForeground': colors['editorHoverWidget.highlightForeground'],
        ...
        'editorOverviewRuler.inlineChatInserted': colors['editorGutter.addedBackground'],
        'editorOverviewRuler.inlineChatRemoved': colors['editorGutter.deletedBackground'],
        'inlineChatInput.background': colors['input.background'],
        'inlineChatInput.border': colors['editorHoverWidget.border'],
        'inlineChatInput.focusBorder': colors['editorHoverWidget.highlightForeground'],
        'inlineChatInput.placeholderForeground': colors['titleBar.inactiveForeground'],
        // Agent sessions and the Agents window
        'agentSessionReadIndicator.foreground': colors['gitDecoration.ignoredResourceForeground'],
        'agentSessionSelectedBadge.border': colors['list.activeSelectionForeground'],
        'agentSessionSelectedUnfocusedBadge.border': colors['gitDecoration.ignoredResourceForeground'],
        ...
        'agentsChatInput.focusBorder': colors['editorHoverWidget.highlightForeground'],
        'agentsChatInput.foreground': colors['input.foreground'],
        'agentsChatInput.placeholderForeground': colors['titleBar.inactiveForeground'],
        ...
        'editorStickyScrollHover.background': colors['editor.lineHighlightBackground'],
        'peekViewEditorStickyScroll.background': colors['peekViewEditor.background'],
        'peekViewEditorStickyScrollGutter.background': colors['peekViewEditor.background'],
        ...
        'terminalStickyScrollHover.background': colors['editor.lineHighlightBackground'],
        // Git and Source Control Graph
        'git.blame.editorDecorationForeground': colors['gitDecoration.ignoredResourceForeground'],
        ...
        'scmGraph.historyItemHoverAdditionsForeground': colors['terminal.ansiGreen'],
        'scmGraph.historyItemHoverDefaultLabelBackground': colors['list.focusBackground'],
        'scmGraph.historyItemHoverDefaultLabelForeground': colors['list.focusForeground'],
...
function withModernUiTokens(colors) {
    const additions = {};
    ...
    return Object.assign(Object.assign({}, colors), additions);
}
//# sourceMappingURL=modernUiTokens.js.map