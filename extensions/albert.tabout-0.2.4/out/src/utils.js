...
exports.selectPreviousCharacter = exports.determinePreviousSpecialCharPosition = exports.selectNextCharacter = exports.determineNextSpecialCharPosition = exports.getNextChar = exports.getPreviousChar = exports.oneNumberIsNegative = exports.returnLowest = exports.returnHighest = void 0;
...
function determinePreviousSpecialCharPosition(text, position) {
...
exports.determinePreviousSpecialCharPosition = determinePreviousSpecialCharPosition;
function selectPreviousCharacter(text, position) {
    ...
    if (previousSpecialCharPosition > -1) {
        ...
        let previousCursorPosition = new vscode_1.Position(vscode_1.window.activeTextEditor.selection.active.line, previousSpecialCharPosition);
        return vscode_1.window.activeTextEditor.selection = new vscode_1.Selection(previousCursorPosition, previousCursorPosition);
    }
    // Default Shift+Tab behavior
    vscode_1.commands.executeCommand("outdent");
}
exports.selectPreviousCharacter = selectPreviousCharacter;
